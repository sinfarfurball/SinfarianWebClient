app.controller('primaryCtrl', primaryController);



function primaryController ($scope, $http, $timeout, $window, ngDialog, alerts, thisPlayer, chatMsgs, settingsStore) {
    ...
    $scope.channels.available = []//chanels currently available to player
    ...
    $scope.selChannel = 132;

    $scope.NewLogActive = false;//needed?
